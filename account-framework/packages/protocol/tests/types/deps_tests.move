...
fun test_deps_new_and_getters() {
    ...
    let deps = deps::new(&extensions, false, vector[b"account_protocol".to_string(), b"account_config".to_string()], vector[@account_protocol, @0x1], vector[1, 1]);
    // assertions
...
fun test_deps_new_latest_extensions() {
    ...
    let deps = deps::new_latest_extensions(&extensions, vector[b"account_protocol".to_string(), b"account_config".to_string()]);
    // assertions
    deps.check(version::current());
    // deps getters
    assert!(deps.length() == 2);
...
fun test_error_deps_missing_account_protocol() {
    ...
    let _deps = deps::new(&extensions, false, vector[b"account_config".to_string()], vector[@0x1], vector[1]);
...
fun test_error_deps_missing_account_config_second_element() {
    ...
    let _deps = deps::new(&extensions, false, vector[b"account_protocol".to_string(), b"account_actions".to_string(), b"account_config".to_string()], vector[@account_protocol, @0x2, @0x1], vector[1, 1, 1]);
...
fun test_error_new_latest_misses_account_protocol() {
    ...
    let _deps = deps::new_latest_extensions(&extensions, vector[b"account_config".to_string()]);
...
fun test_error_new_inner_missing_account_protocol() {
    ...
    let deps = deps::new_for_testing();
    let _deps = deps::new_inner(&extensions, &deps, vector[b"account_config".to_string()], vector[@0x1], vector[1]);
...
fun test_error_new_inner_missing_account_config_second_element() {
    ...
    let deps = deps::new_for_testing();
    let _deps = deps::new_inner(&extensions, &deps, vector[b"account_protocol".to_string(), b"account_actions".to_string(), b"account_config".to_string()], vector[@account_protocol, @0x2, @0x1], vector[1, 1, 1]);
...
fun test_error_new_inner_add_not_extension_unverified_not_allowed() {
    ...
    let deps = deps::new_for_testing();
    let _deps = deps::new_inner(&extensions, &deps, vector[b"account_protocol".to_string(), b"account_config".to_string(), b"Other".to_string()], vector[@account_protocol, @0x1, @0xB], vector[1, 1, 1]);
...
fun test_error_new_inner_add_name_already_exists() {
    ...
    let deps = deps::new_for_testing();
    let _deps = deps::new_inner(&extensions, &deps, vector[b"account_protocol".to_string(), b"account_config".to_string(), b"account_protocol".to_string()], vector[@account_protocol, @0x1, @account_protocol], vector[1, 1, 1]);
